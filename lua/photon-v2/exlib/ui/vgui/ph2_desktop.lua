...
function PANEL:SetupRenderOptions()
	...
	form:CreateCheckBoxProperty( { "ph2_enable_overexposure_sprites", "Bool" }, "Overexposure 2D", true, { Descriptor = "Simulate overexposure" } )

	form:AddParagraph( "Subtractive rendering increases light color saturation, while additive rendering enhances bloom intensity. Overexposure simulation makes lights appear less saturated in dark areas. You can disable these options for slightly better performance. (Applies to 2D lights only.)" )
	form:AddDivider()
